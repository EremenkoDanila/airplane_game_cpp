...
Airplane::Airplane(char flg, int hp, int speed, const std::string& texturePath, const sf::Vector2f& position, unsigned int window_width, unsigned int window_height) : shooting("../pic/bullet.png", 10.f) {
    this->hp_ = hp;
    this->speed_ = speed;
